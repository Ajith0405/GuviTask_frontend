...
const Profile = () => {
  ...
  useEffect(() => {
    console.log(id);
    axios.get('https://mernappbackend-thsp.onrender.com/getUser/' + id, {})
      .then(res => {
        console.log(res);
  ...
  const handleSave = (e) => {
    e.preventDefault();
    axios.put('https://mernappbackend-thsp.onrender.com/updateUser/'+id,{age,dob,gender,mobile,highEdu})
    .then(res=>{
        console.log(res)
  ...
  return (
    <div>
      ...
      <div className=' mt-3 container'>
        <div className='row '>
          <div className='col-5 col-lg-5 col-md-6 bg-dark px-3' style={{ backgroundColor: 'gray', height: '85vh',margin:'0px 30px',borderRadius:'20px 20px 20px 20px'}}>
          ...
          <div className='col-5 col-lg-5 col-md-6 '>
              <div className='text-center'>
